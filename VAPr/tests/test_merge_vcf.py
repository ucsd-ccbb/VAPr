...
class TestMergeVcfs(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.vcf_mapping_dicts_files = [{'sample_names': ['X45'], 'num_samples_in_csv': 1,
                                         ...
                                         'csv_file_basename': 'X45.raw.21_annotated', 'vcf_file_basename': 'X45.raw.22.vcf',
    ...
    def test_merge_vcfs(self):
        print(MergeVcfs(input_dir=self.files_input_dir,
                        ...
                        analysis_name=self.merged_vcf).merge_vcfs())

    def test_merge_vcfs_single(self):
        print(MergeVcfs(input_dir=self.files_input_dir,
                        output_dir=self.output_dir,
                        list_of_vcf_mapping_dicts=[self.vcf_mapping_dicts_files[0]],
                        analysis_name=self.vcf_mapping_dicts_files[0]['raw_vcf_file_full_path']).merge_vcfs())
