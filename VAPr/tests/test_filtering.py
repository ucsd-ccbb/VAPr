...
class TestFunctions(unittest.TestCase):
    ...
    def test_make_rare_deleterious_variants_filter(self):
        expected_output = {
            "$and":
                [
                    {
    ...
    def test_make_known_disease_variants_filter(self):
        expected_output = {
            "$or":
                    [
                        {
    ...
    def test_make_deleterious_compound_heterozygote_variants_filter(self):
        expected_output = {
            "$and":
                [
