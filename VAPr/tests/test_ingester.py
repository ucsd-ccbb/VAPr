...
class TestIngester(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.output_csv_path = os.path.join(self.base_dir, 'test_files/test_out_csv_path/des_file_files')
        ...
        self.x_45_c1 = {'sample_names': ['X45'],
                        ...
                        'csv_file_full_path': os.path.join(self.base_dir, 'test_files/test_out_csv_path/des_file_files/X45'),
    ...
    def test_input_design_file_dirs(self):
        organizer = Ingester(self.samples_input_dir, self.output_csv_path)
    ...
    def test_input_design_files(self):
        organizer = Ingester(self.files_input_dir, self.output_csv_path)
